--https://openrange.medinformatix.com/ebenGunadi/PAM/blob/master/Good_Sam/Scripts/ShowDecrypted.sql

USE [test]
GO
/****** Object:  StoredProcedure [dbo].[ShowDecrypted]    Script Date: 04/20/2018 01:16:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[ShowDecrypted]
AS
...
WHERE name = N'AR_XOVERSP' --<=Either put your object name here or make sure @object_id is set, and that the object it relates to is encrypted.
